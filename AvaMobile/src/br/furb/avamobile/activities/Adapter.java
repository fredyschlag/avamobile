...
public class Adapter extends BaseExpandableListAdapter
{
	...
	public View getGroupView(int groupPosition, boolean isExpanded,	View convertView, ViewGroup parent)
	{
		...
		ImageView ivImagemView = (ImageView)convertView.findViewById(R.id.imagemview);
		
		tvText.setText(item.getName());
		
		// TODO: pegar o objeto verificar se esta pago ou não
		ivImagemView.setImageResource(item.getIconeRID());
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
	{
		...
		TextView tvText = (TextView)convertView.findViewById(R.id.text);		
		tvText.setText(getChild(groupPosition, childPosition).toString());
